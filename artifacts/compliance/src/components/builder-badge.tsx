...
// Official LinkedIn "in" brand mark (authentic vector path), rendered inline
// so it stays crisp at any size with no external asset dependency.
            ...
            <div className="mt-4 flex items-center justify-between">
              ...
              >
                <a href={LINKEDIN_URL} target="_blank" rel="noopener noreferrer">
                  <LinkedInLogo className="w-4 h-4" /> Connect on LinkedIn
                </a>
              </Button>
            </div>
          </div>
