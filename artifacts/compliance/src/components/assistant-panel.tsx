    ...
    (raw: string) => {
      ...
      const startTimer = () => {
        ...
        timer = setInterval(() => {
          ...
          // ~55 chars/sec baseline (readable typing pace); accelerate when
          // the backlog grows so we trail the model by ~3s at most.
          const n = Math.max(2, Math.ceil(buffer.length / 80))
