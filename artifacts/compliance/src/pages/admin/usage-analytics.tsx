...
export default function UsageAnalytics() {
  ...
  const isLoading = trendsLoading || categoriesLoading || violationsLoading || vendorsLoading || statsLoading || langLoading;
            ...
            <Card className="lg:col-span-2">
              ...
              <CardContent className="h-80">
                {trends && trends.length > 0 ? (
                  ...
                  <div className="flex h-full items-center justify-center text-muted-foreground bg-muted/20 rounded-lg">No trend data available</div>
                )}
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="h-80">
                {violations && violations.length > 0 ? (
                  ...
                  <div className="flex h-full items-center justify-center text-muted-foreground bg-muted/20 rounded-lg">No violation data available</div>
                )}
              </CardContent>
            </Card>
